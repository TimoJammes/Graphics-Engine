...
public class ObjMatrix {
    ...
    ObjMatrix add(ObjMatrix m2) {
        ...
        ObjMatrix res = new ObjMatrix(newArray);

        return res;
    }

    ObjMatrix matmul(ObjMatrix m2) {
    ...
    static float normSqr(ObjMatrix m) {
        float sum = 0;
...
class Vector extends ObjMatrix {
